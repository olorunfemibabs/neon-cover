    ...
    <div className='fixed top-0 w-[100%] ' >
        <div className="w-[60%] ml-14 bg-white mt-10 rounded-lg">
            ...
            Register Insurance
                ...
                <p className="font-normal text-[14px] leading-4 text-[#959595] mt-[14px] ">Fill the Form to register Insurance</p>
                    </div>
                ...
                <form >
                    ...
                    <div className="w-[48%]">
                        <label className='text-[16px] font-[400] leading-5'>Family Name</label> <br/>
                        <input type="text" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' />
                    </div>
                    <div className="w-[48%]">
                        <label className='text-[16px] font-[400] leading-5'>Package Type</label> <br/>
                        {/* <input type="text" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' /> */}
                        <select name="" id="" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' >
                    ...
                    <div className="w-[48%]">
                        <label className='text-[16px] font-[400] leading-5'>Do any of you smoke</label> <br/>
                        <select name="" id="" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' >
                    ...
                    <div className="w-[48%]">
                        <label className='text-[16px] font-[400] leading-5'>Any Family Disease</label> <br/>
                        <select name="" id="" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' >
                            <option value="">Yes</option>
                            <option value="">No</option>
                    ...
                    <div className="w-[48%]">
                        <label className='text-[16px] font-[400] leading-5'>Cover To buy</label> <br/>
                        <select name="" id="" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' >
                    ...
                    <div className="w-[48%]">
                        <label className='text-[16px] font-[400] leading-5'>Family Number</label> <br/>
                        <select name="" id="" className='h-[50px] w-[100%] border-[1px] border-[#E5E5E5] rounded-lg bg-[#F9F9F9] outline-[#1A1941]  mt-2' >
...
<button className='text-[16px] font-bold w-[100%] h-[50px] bg-[#1A1941] text-[#FFFFFF] rounded-lg mt-4'>Submit</button>
